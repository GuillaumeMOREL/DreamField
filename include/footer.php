    ...
    <div class="container">
      <div id="texte_footer">
        <ul>
          ...
          <li><a href="facebook"><img class="logo_reseaux_sociaux" src="/logo/facebook.png"/></a></li>
          <li><a href="twitter"><img class="logo_reseaux_sociaux" src="/logo/twitter.png"/></a></li>
          <li><a href="google"><img class="logo_reseaux_sociaux" src="/logo/google.png"/></a></li>
        </ul>
      </div>
    </div>
</footer>